...
- [DFRobot Beetle ESP32-C6](/devices/beetle-esp32-c6) - Used for I2C communication with touch controller
- [Pimoroni Touch pHAT](/devices/touch-phat) - CAP1166 capacitive touch controller via I2C
- [SH1107 OLED Display (128x128, SPI)](/devices/sh1107-spi-oled) - While primarily SPI, some variants support I2C
